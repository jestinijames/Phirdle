...
import { VALID_FIVE_LETTER_GUESSES } from '../constant/validFiveLetterGuesses';

const useFiveLetterWordle = (solution) => {
  ...
  const handleKeyup = ({ key }) => {
    if (key === 'Enter') {
      ...
      if (!VALID_FIVE_LETTER_GUESSES.includes(currentGuess)) {
        // console.log('word must be 5 chars.');
...
export default useFiveLetterWordle;
